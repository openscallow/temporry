<script>
    ...
    function showThumbsAsActive() {
      activeImage = thumbImagesDivs[currentIndex].original;
    }
  ...
  <section class="product-wrapper">
    <div class="container">
      <div class="product-images-wrapper">
        <div class="preview-image-wrapper">
          ...
          <div class="arrows hide-for-desktop">
            ...
            <div class="prev" on:click={prevImage}>
      ...
      <div class="product-details-wrapper">
        <p class="product-brabd">{productObj.compnay}</p>
